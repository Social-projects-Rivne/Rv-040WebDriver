...
class UsrPageLocators:
    ...
    user_button_locator = (By.XPATH, "/html/body/div[1]/nav/section/ul[2]/li/ul/li[5]/a")
    ...
    new_user_save_button_locator = (By.XPATH, "/html/body/div[2]/div[3]/form/div[3]/div[2]/input")
